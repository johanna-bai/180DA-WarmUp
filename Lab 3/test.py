...
# Load images
rock_img = pygame.image.load(os.path.join(os.getcwd(), r"/Users/johannabai/Desktop/rock.jpeg"))
paper_img = pygame.image.load(os.path.join(os.getcwd(), r"/Users/johannabai/Desktop/paper.jpeg"))
scissors_img = pygame.image.load(
    os.path.join(os.getcwd(), r"/Users/johannabai/Desktop/scissors.jpeg"))
...
def on_connect(client, userdata, flags, rc):
    ...
    client.subscribe("ece180d/jacob/lab2/player1", qos=1)
...
def main():
    ...
    while True:
        ...
        client.publish("ece180d/jacob/lab2/player2", user_choice, qos=1)
